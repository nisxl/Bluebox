      ...
      <Element className="section2">
        <section class="text-gray-600">
          <div className="font-montserrat font-[550] text-lg container px-5 py-24 mx-auto">
              ...
              <div class="xl:w-1/3 md:w-1/2 p-6 ">
                <div class=" p-6 h-[500px] bg-[#5f2a7c] rounded-tl-[50px]">
                  <div>
                    ...
                    <p class="leading-relaxed">
                      For companies ready for an advance, wide-reaching &
                      dominate appoach to SMM
                    </p>
                  </div>
            ...
            <button class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-2xl">
              Button
            </button>
          </div>
        </section>
